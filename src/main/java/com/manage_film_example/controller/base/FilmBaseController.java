...
//CRUD METHODS
    ...
    //CRUD - LINK LIST cast
    @Secured({"ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/films/cast/{key}", method = RequestMethod.POST, headers = "Accept=application/json")
	public void linkListcast(@PathVariable("key") Long idcast) {}
	

    //CRUD - LINK LIST filmMaker
    @Secured({"ROLE_PRIVATE_USER" })
	@RequestMapping(value = "/films/filmMaker/{key}", method = RequestMethod.POST, headers = "Accept=application/json")
	public void linkListfilmMaker(@PathVariable("key") Long idfilmMaker) {}
